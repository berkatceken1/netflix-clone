...
import { SMALL_IMG_BASE_URL, CATEGORY_TRANSLATIONS } from "../utils/constants";
...
const MovieSlider = ({ category }) => {
  ...
  const formettedCategoryName = CATEGORY_TRANSLATIONS[category];
  // category.replaceAll("_", " ")[0].toUpperCase() +
  // category.replaceAll("_", " ").slice(1); // İngilizce olsa bu şekilde yapardık
  const formattedContentType = contentType === "movie" ? "Filmler" : "Diziler";
  ...
  return (
    ...
    >
      <h2 className="mb-4 text-2xl font-bold">
        {formettedCategoryName} {formattedContentType}
      </h2>
